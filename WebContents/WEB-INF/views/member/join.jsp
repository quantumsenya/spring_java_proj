			 ...
			 <div class="card card-signin my-5">
				<div class="card-body">
					...
					<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
						...
						<div class="form-label-group">
							<label>이메일 : </label>
							<input type="email" name="email" class="form-control" value="${dto.email}" required="required" placeholder="사용중인 이메일을 입력하세요">
							<form:errors path="memberDTO.email" element="div" class="input_errors" />
						</div>
						<div class="form-label-group">
							<label>전화번호 : </label>
							<input type="number" name="phoneNum" class="form-control" value="${dto.phoneNum}" required="required" placeholder="사용중인 전화번호를 입력하세요">
